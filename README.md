...
A beautiful, eco-friendly, and easy-to-edit website for Solwara Youth Guardian (SYG INC) built with simple HTML, CSS, and JavaScript.

## Features

- **Plant-based rustic design** with earthy browns, forest greens, and autumn oranges
- **Organic textures and natural typography** inspired by nature
- **Floating draggable toggle menu** for quick social media access
- **Clean, rustic aesthetic** with visual interest
...
The website uses a plant-based rustic palette:
- **60% Earthy Brown** - Primary color for navigation, hero section, and main elements (soil, bark, wood tones)
- **30% Forest Green** - Secondary color for buttons and highlights (leaves, moss, plants)
- **10% Rustic Orange** - Accent color for special buttons and features (dried leaves, autumn)

Plus natural neutrals like sand, cream, and earth tones for a harmonious, rustic, plant-inspired palette.

## Design Highlights

- **Gradient backgrounds** that mimic ocean waves and forest canopies
- **Rounded corners** (20-25px) for soft, organic feel
- **Clean, minimalist design** with visual interest
- **Floating draggable toggle menu** with circular social media icon expansion
- **Wave patterns** at section transitions
- **Hover animations** that lift and scale cards gently
- **Pulse animations** on innovation cards
...
- Update the floating menu social links in the HTML (near the end of the file) with your actual URLs
- The floating menu shows 6 social media icons: Facebook, Twitter, Instagram, YouTube, WhatsApp, and LinkedIn
- Find the social-links div in the Contact section and replace the `#` with your actual social media URLs
...
- Modify the navigation items in the HTML (lines 287-330)
- Modify the colors in the CSS under `.radial-menu` section
- To change the toggle icon, edit the emoji in `<span class="toggle-icon">🌊</span>`
...
Enjoy your beautiful, nature-inspired website!
